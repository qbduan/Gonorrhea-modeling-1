...
public:
    ...
    /* periods 
    column 0 : time become infectious but asymptomatic; column 1 : time become infectious but symptomatic;
    column 2 : time become recovered; column 3 : time become susceptive.
    */
    umat periods = zeros<umat>(3, 4); 
...
int main(int argc, char *argv[])
{
    ...
    unsigned batchsize = 1; //For each job task, the program would run for many times (batchsize).
                         ...
                         bool reconsc, bool regular, bool casual, double par_rr, double par_rcr, default_random_engine generator) //recommended screening, casual par_rcr
{
    ...
    for (unsigned int d = 1; d < max_day + 1; d++)
    {
        ...
        for (unsigned int n = 0; n < Patsid.n_rows; n++)
        {
            ...
            //individual has symptomatic NG and during the symptomatic period, there will be no infections.
